...
const seloCriador = {
  key: {
    participant: "556199317165@s.whatsapp.net",
    remoteJid: "status@broadcast",
    fromMe: false,
  },
  message: {
    contactMessage: {
      displayName: "Pedrozz Mods",
...
const seloLaura = {
  key: {
    participant: "556191969269@s.whatsapp.net",
    remoteJid: "status@broadcast",
    fromMe: false,
  },
  message: {
    contactMessage: {
      displayName: "Laura AI",
...
const seloNubank = {
  key: {
    participant: "551150390444@s.whatsapp.net",
    remoteJid: "status@broadcast",
    fromMe: false,
  },
  message: {
...
const seloBb = {
  key: {
    participant: "556140040001@s.whatsapp.net",
    remoteJid: "status@broadcast",
    fromMe: false,
  },
  message: {
...
const seloBradesco = {
  key: {
    participant: "551133350237@s.whatsapp.net",
    remoteJid: "status@broadcast",
    fromMe: false,
  },
  message: {
...
const seloSantander = {
  key: {
    participant: "551140043535@s.whatsapp.net",
    remoteJid: "status@broadcast",
    fromMe: false,
  },
  message: {
...
const seloItau = {
  key: {
    participant: "551140044828@s.whatsapp.net",
    remoteJid: "status@broadcast",
    fromMe: false,
  },
  message: {
...
const selodoc = {
  key: { fromMe: false, participant: "0@s.whatsapp.net" },
  message: { documentMessage: { title: "Bem vindo", jpegThumbnail: null } },
};
...
const enviarBan = async (loki, subaru, from, msgKey, senderJid) => {
  const selob = {
    key: {
      fromMe: false,
      participant: "0@s.whatsapp.net",
  ...
  await subaru.sendMessage(from, { text: loki }, { quoted: selob });
