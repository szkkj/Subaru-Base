...
const makeNewsletterSocket = (config) => {
  ...
  const { groupQuery, query, generateMessageTag } = sock;
  ...
  const newsletterUpdate = async (jid, updates) => {
    ...
    return executeWMexQuery(
      variables,
      Types_1.QueryIds.UPDATE_METADATA,
  ...
  return {
    ...
    newsletterFollow: (jid) => {
      return executeWMexQuery(
        ...
        Types_1.XWAPaths.xwa2_newsletter_follow,
      );
    },
    ...
    newsletterMute: (jid) => {
      return executeWMexQuery(
        ...
        Types_1.XWAPaths.xwa2_newsletter_mute_v2,
      );
    },
    ...
    newsletterUpdatePicture: async (jid, content) => {
      const { img } = await (0, messages_media_1.generateProfilePicture)(
        content,
      );
    ...
    subscribeNewsletterUpdates: async (jid) => {
      ...
      const liveUpdatesNode = (0, WABinary_1.getBinaryNodeChild)(
        result,
        "live_updates",
      );
      const duration =
        (_a =
          liveUpdatesNode === null || liveUpdatesNode === void 0
            ? void 0
            : liveUpdatesNode.attrs) === null || _a === void 0
          ? void 0
          : _a.duration;
