...
const extractImageThumb = async (bufferOrFilePath, width = 32) => {
  ...
  if (
    ...
    "jimp" in lib &&
    typeof ((_b = lib.jimp) === null || _b === void 0 ? void 0 : _b.Jimp) ===
      "object"
  ) {
...
async function getAudioWaveform(buffer, logger) {
  try {
    // @ts-ignore
    const { default: decoder } = await Promise.resolve().then(() =>
      __importStar(require("audio-decode")),
    );
    let audioData;
    if (Buffer.isBuffer(buffer)) {
      audioData = buffer;
...
const getHttpStream = async (url, options = {}) => {
  ...
  if (!response.ok) {
    throw new boom_1.Boom(`Failed to fetch stream from ${url}`, {
      statusCode: response.status,
      data: { url },
    });
  }
  // @ts-ignore Node18+ Readable.fromWeb exists
  return response.body instanceof stream_1.Readable
    ? response.body
...
const encryptedStream = async (
  ...
  try {
    ...
    (_a =
      originalFileStream === null || originalFileStream === void 0
        ? void 0
        : originalFileStream.end) === null || _a === void 0
      ? void 0
      : _a.call(originalFileStream);
    stream.destroy();
    logger === null || logger === void 0
      ? void 0
    ...
    (_b =
      originalFileStream === null || originalFileStream === void 0
        ? void 0
        : originalFileStream.destroy) === null || _b === void 0
      ? void 0
      : _b.call(originalFileStream);
    aes.destroy();
    hmac.destroy();
    sha256Plain.destroy();
    sha256Enc.destroy();
...
function extensionForMediaMessage(message) {
  const getExtension = (mimetype) => {
    var _a;
    return (_a = mimetype.split(";")[0]) === null || _a === void 0
      ? void 0
      : _a.split("/")[1];
  };
  ...
  return async (filePath, { mediaType, fileEncSha256B64, timeoutMs }) => {
    ...
    for (const { hostname } of hosts) {
      ...
      try {
        ...
        const isLast =
          hostname ===
          ((_a = hosts[uploadInfo.hosts.length - 1]) === null || _a === void 0
            ? void 0
            : _a.hostname);
        logger.warn(
          {
