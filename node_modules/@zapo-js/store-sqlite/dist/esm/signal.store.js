...
export class WaSignalSqliteStore extends BaseSqliteStore {
    ...
    getMeta(db) {
        ...
        const row = db.get(`SELECT signed_prekey_rotation_ts
             ...
             WHERE session_id = ?`, [this.options.sessionId]);
        return {
            signedPreKeyRotationTs: asOptionalNumber(row.signed_prekey_rotation_ts, 'signal_meta.signed_prekey_rotation_ts') ?? null
        };
    }
}
