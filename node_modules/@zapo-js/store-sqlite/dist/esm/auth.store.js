...
import { asBytes, asNumber, asOptionalBytes, asOptionalNumber, asOptionalString, toBoolOrUndef } from 'zapo-js/util';
import { BaseSqliteStore } from './BaseSqliteStore.js';
export class WaAuthSqliteStore extends BaseSqliteStore {
    constructor(options) {
        super(options, ['auth']);
    }
    async load() {
