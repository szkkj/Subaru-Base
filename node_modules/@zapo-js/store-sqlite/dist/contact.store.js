...
function decodeContactRow(row) {
    return {
        jid: (0, util_1.asString)(row.jid, 'mailbox_contacts.jid'),
        displayName: (0, util_1.asOptionalString)(row.display_name, 'mailbox_contacts.display_name'),
        pushName: (0, util_1.asOptionalString)(row.push_name, 'mailbox_contacts.push_name'),
        lid: (0, util_1.asOptionalString)(row.lid, 'mailbox_contacts.lid'),
        phoneNumber: (0, util_1.asOptionalString)(row.phone_number, 'mailbox_contacts.phone_number'),
        username: (0, util_1.asOptionalString)(row.username, 'mailbox_contacts.username'),
        lastUpdatedMs: (0, util_1.asNumber)(row.last_updated_ms, 'mailbox_contacts.last_updated_ms')
    };
}
