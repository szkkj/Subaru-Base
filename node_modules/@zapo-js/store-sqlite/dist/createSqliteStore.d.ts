...
import type { WaSqliteBatchSizeSelection, WaSqliteDriver, WaSqliteTableNameOverrides } from './types';
 ...
 * ```
 */
export declare function createSqliteStore(config: WaSqliteStoreConfig): WaSqliteStoreResult;
