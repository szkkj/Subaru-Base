...
exports.toChunkBytes = toChunkBytes;
exports.uint8TimingSafeEqual = uint8TimingSafeEqual;
exports.uint8Equal = uint8Equal;
 ...
 */
function bytesToBase64UrlSafe(value) {
...
function intToBytes(byteLength, value) {
