 ...
 */
export function toSerializedPubKey(key) {
    if (key.length === 33) {
 ...
 */
export function toRawPubKey(key) {
    if (key.length === 32) {
        return key;
    }
 ...
 */
export function prependVersion(content, version) {
 ...
 */
export function readVersionedContent(versionContent, expectedVersion, suffixLength) {
