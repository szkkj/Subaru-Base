...
export function createPeerDataOperationRequester(options) {
    ...
    const publish = async (type, body, id) => {
        ...
        const result = await publishProtocolMessageToDevice(toUserJid(meJid), buildRequestProtocolMessage(type, body), { id, pushPriority: 'high_force' });
        return result.id;
    };
    return {
