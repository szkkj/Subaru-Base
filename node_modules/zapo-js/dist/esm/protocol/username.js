...
export function validateUsernameLocally(username) {
    ...
    if (!hasLetter)
        return invalid(WA_USERNAME_VALIDATION_ERRORS.INVALID_NO_LETTERS);
...
export function isUsernameKey(key) {
    if (key.length !== WA_USERNAME_LIMITS.KEY_LENGTH)
        return false;
 ...
 */
export function splitUsernameHandle(input) {
...
export function parseUsernameHandle(input) {
