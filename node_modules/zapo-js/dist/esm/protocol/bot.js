...
const PN_TO_FBID_BOT = Object.freeze({
    [WA_BOT_KNOWN_JIDS.META_AI_PN]: WA_BOT_KNOWN_JIDS.META_AI_FBID
});
export function resolveBotFbidJid(jid) {
    if (isBotJid(jid))
        return jid;
...
export const WA_BLOKS_VERSIONING_ID = '98153664e5d904059a94ea08a59fc7eeaf977544cec64ab3ab793c0ce001eb92';
...
export const WA_BOT_DEFAULT_CAPABILITIES = Object.freeze([
