...
function parseSubgroupSuggestion(node) {
    ...
    return {
        ...
        isExistingGroup: getNodeTextContent(isExistingGroupNode) === undefined
            ? undefined
...
function parseCreateGroupAction(notificationNode, actionNode) {
    ...
    return {
        ...
        details: {
            ...
            noFrequentlyForwardedEnabled: findNodeChild(groupNode, WA_GROUP_NOTIFICATION_TAGS.NO_FREQUENTLY_FORWARDED) !==
                undefined,
            ...
            hiddenSubgroup: findNodeChild(groupNode, 'hidden_group') !== undefined,
            groupSafetyCheck: findNodeChild(groupNode, WA_GROUP_NOTIFICATION_TAGS.GROUP_SAFETY_CHECK) !==
                undefined,
            hasCapi: findNodeChild(groupNode, 'capi') !== undefined,
            limitSharingEnabled: findNodeChild(groupNode, WA_GROUP_NOTIFICATION_TAGS.LIMIT_SHARING_ENABLED) !==
                undefined,
...
function parseGroupActionNode(notificationNode, actionNode) {
    ...
    switch (actionNode.tag) {
        ...
        case WA_GROUP_NOTIFICATION_TAGS.DESCRIPTION: {
            const hasDeleteChild = findNodeChild(actionNode, WA_GROUP_NOTIFICATION_TAGS.DELETE) !== undefined;
...
export function parseGroupNotificationEvents(notificationNode) {
