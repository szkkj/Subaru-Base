import { WA_NEWSLETTER_MUTE_TYPES, WA_NEWSLETTER_MUTE_VALUES, WA_NEWSLETTER_STATE_TYPES } from '../../protocol/newsletter.js';
...
export function parseNewsletterMetadata(envelope) {
...
export function parseAdminInfo(data) {
...
export function parseAdminCapabilities(data) {
    return new Set(data?.xwa2_newsletter_admin?.capabilities ?? []);
}
export function parsePendingInvites(data) {
...
export function parseDirectoryCategoriesPreview(data) {
    const result = [];
...
export function parseDehydratedMetadata(data) {
...
export function parseAdminInviteResult(data) {
...
export function parseReactionSenders(data) {
...
export function parsePollVoters(data) {
    const map = new Map();
