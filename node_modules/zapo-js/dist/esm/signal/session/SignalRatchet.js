...
import { removeAt, uint8Equal, uint8TimingSafeEqual } from '../../util/bytes.js';
...
export function selectMessageKey(chain, targetCounter) {
...
export function encryptMsg(session, plaintext) {
