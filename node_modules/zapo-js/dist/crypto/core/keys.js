...
exports.toSerializedPubKey = toSerializedPubKey;
exports.toRawPubKey = toRawPubKey;
 ...
 */
function prependVersion(content, version) {
 ...
 */
function readVersionedContent(versionContent, expectedVersion, suffixLength) {
