...
export interface WaMediaProcessor {
    readonly generateImageThumbnail?: (input: WaMediaProcessorInput, maxEdge: number, ctx?: WaMediaProcessorCallContext) => Promise<WaMediaProcessorImageResult>;
    readonly generateVideoThumbnail?: (input: WaMediaProcessorInput, maxEdge: number, ctx?: WaMediaProcessorCallContext) => Promise<WaMediaProcessorImageResult | null>;
    readonly probeMedia?: (input: WaMediaProcessorInput, ctx?: WaMediaProcessorCallContext) => Promise<WaMediaProcessorProbeResult>;
    readonly computeWaveform?: (input: WaMediaProcessorInput, ctx?: WaMediaProcessorCallContext) => Promise<WaMediaProcessorWaveformResult | null>;
    readonly normalizeVoiceNote?: (input: WaMediaProcessorInput, ctx?: WaMediaProcessorCallContext) => Promise<Readable | null>;
    readonly generateStickerThumbnail?: (input: WaMediaProcessorInput, maxEdge: number, ctx?: WaMediaProcessorCallContext) => Promise<WaMediaProcessorStickerThumbnailResult>;
    /**
     ...
     */
    readonly detectMimetype?: (input: string | Uint8Array, ctx?: WaMediaProcessorCallContext) => Promise<string | null>;
}
