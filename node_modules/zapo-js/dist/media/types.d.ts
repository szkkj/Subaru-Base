...
export type MediaCryptoType = MediaKind | 'ptt' | 'gif' | 'history' | 'group-history' | 'md-app-state' | 'md-msg-hist' | 'xma-image' | 'sticker-pack' | 'thumbnail-sticker-pack' | 'thumbnail-link';
