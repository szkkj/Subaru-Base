...
function createStreamControlHandler(options) {
    ...
    return {
        handleStreamControlResult: async (result) => {
            switch (result.kind) {
                case constants_1.WA_STREAM_SIGNALING.XML_STREAM_END_TAG:
                ...
                case 'stream_error_code':
                    ...
                    return;
                case constants_1.WA_DISCONNECT_REASONS.STREAM_ERROR_REPLACED:
                    ...
                    return;
                case constants_1.WA_DISCONNECT_REASONS.STREAM_ERROR_DEVICE_REMOVED:
                    ...
                    return;
                case constants_1.WA_DISCONNECT_REASONS.STREAM_ERROR_ACK:
                    ...
                    return;
                case constants_1.WA_DISCONNECT_REASONS.STREAM_ERROR_XML_NOT_WELL_FORMED:
                    ...
                    return;
                case constants_1.WA_DISCONNECT_REASONS.STREAM_ERROR_OTHER:
