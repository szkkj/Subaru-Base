...
exports.WaPassiveTasksCoordinator = void 0;
const constants_1 = require("../../protocol/constants");
const constants_2 = require("../../signal/api/constants");
const prekeys_1 = require("../../signal/api/prekeys");
const keygen_1 = require("../../signal/registration/keygen");
const passive_1 = require("../../transport/node/builders/passive");
const primitives_1 = require("../../util/primitives");
class WaPassiveTasksCoordinator {
    constructor(options) {
        ...
        this.signedPreKeyRotationIntervalMs =
            options.signedPreKeyRotationIntervalMs ?? constants_2.SIGNAL_SIGNED_PREKEY_ROTATION_INTERVAL_MS;
    ...
    async runPassiveTasksAfterConnect() {
    ...
    async sendActiveModeIq() {
        try {
            await this.runtime.queryWithContext('passive.active', (0, passive_1.buildPassiveModeIqNode)('active'), constants_1.WA_DEFAULTS.IQ_TIMEOUT_MS);
        }
        catch (error) {
    ...
    async uploadPreKeysIfMissing(serverHasPreKeysHint, prefetchedLocalKeyBundle) {
        ...
        const uploadNode = (0, prekeys_1.buildPreKeyUploadIq)(registrationInfo, signedPreKey, preKeys);
        ...
        const failure = (0, prekeys_1.parsePreKeyUploadFailure)(response);
...
exports.WaPassiveTasksCoordinator = WaPassiveTasksCoordinator;
