...
import { type BuildChatstateNodeInput } from '../../transport/node/builders/chatstate';
import { type BuildPresenceSubscribeNodeInput } from '../../transport/node/builders/presence';
...
export interface WaPresenceCoordinator {
    ...
    readonly sendChatstate: (jid: string, options: Omit<BuildChatstateNodeInput, 'jid'>) => Promise<void>;
    /**
     ...
     */
    readonly subscribe: (jid: string, options?: Omit<BuildPresenceSubscribeNodeInput, 'jid'>) => Promise<void>;
}
