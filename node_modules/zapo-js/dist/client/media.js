...
exports.readFileHead = readFileHead;
...
function parseWebpAnimation(data) {
...
async function streamToTempFile(source) {
    ...
    try {
        await (0, promises_2.pipeline)(source, (0, node_fs_1.createWriteStream)(filePath));
    }
    catch (error) {
    ...
    if (isReadableStream(raw)) {
        if (shouldProcess) {
            ...
            return {
                ...
                uploadMedia: (0, node_fs_1.createReadStream)(tempFilePath),
                tempFilePath
            };
        }
...
function hasMediaProcessingTasks(media, content) {
