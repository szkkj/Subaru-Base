...
exports.buildExtendedTextWithPreview = buildExtendedTextWithPreview;
function buildExtendedTextWithPreview(text, resolved, thumbnailFields) {
    const message = {
        text,
