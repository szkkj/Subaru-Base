...
exports.pickIncomingEphemeralSettingTimestamp = pickIncomingEphemeralSettingTimestamp;
...
function applyContextInfo(message, ctx) {
    if (!ctx)
        return message;
 ...
 */
function pickIncomingExpirationSeconds(message) {
    if (!message)
        return undefined;
 ...
 */
function pickIncomingEphemeralSettingTimestamp(message) {
    if (!message)
        return undefined;
    const inner = message.ephemeralMessage?.message ?? message;
    for (const key of Object.keys(inner)) {
        ...
        if (value &&
            ...
            if (stamp !== undefined && stamp !== null) {
                return (0, primitives_1.longToNumber)(stamp);
            }
        }
    }
    return undefined;
