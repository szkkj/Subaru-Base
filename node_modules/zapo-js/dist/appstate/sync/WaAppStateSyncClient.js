...
class WaAppStateSyncClient {
    ...
    async buildCollectionSyncRequest(collection, pendingByCollection, activeSyncKey) {
        ...
        return {
            ...
            skippedUpload,
            node: {
                tag: constants_2.WA_NODE_TAGS.COLLECTION,
                attrs,
    ...
    buildSyncIqNode(collectionNodes) {
        return {
            tag: constants_2.WA_NODE_TAGS.IQ,
            attrs: {
                to: this.hostDomain,
                type: constants_2.WA_IQ_TYPES.SET,
                xmlns: constants_2.WA_XMLNS.APP_STATE_SYNC
            },
            content: [
                {
    ...
    async processCollectionRound({ collection, payloadByCollection, pendingByCollection, options, outgoingContexts, skippedUploadCollections }) {
        ...
        if (payload.state === constants_2.WA_APP_STATE_COLLECTION_STATES.ERROR_FATAL ||
            payload.state === constants_2.WA_APP_STATE_COLLECTION_STATES.ERROR_RETRY) {
...
exports.WaAppStateSyncClient = WaAppStateSyncClient;
